...
#define one_Pin GPIO_PIN_0
#define one_GPIO_Port GPIOD
#define two_Pin GPIO_PIN_1
#define two_GPIO_Port GPIOD
#define three_Pin GPIO_PIN_2
#define three_GPIO_Port GPIOD
#define four_Pin GPIO_PIN_3
#define four_GPIO_Port GPIOD
#define five_Pin GPIO_PIN_4
#define five_GPIO_Port GPIOD
#define six_Pin GPIO_PIN_5
#define six_GPIO_Port GPIOD
#define seven_Pin GPIO_PIN_6
#define seven_GPIO_Port GPIOD
#define eight_Pin GPIO_PIN_7
#define eight_GPIO_Port GPIOD
