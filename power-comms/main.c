...
// LED output register
  ...
  *led_output_registers = 0x5555;
  ...
  HD44780_CreateSpecialChar(0, Filled);
  HD44780_CreateSpecialChar(1, Empty);
  HD44780_CreateSpecialChar(2, TopTwo);
  HD44780_CreateSpecialChar(3, BottomTwo);
  HD44780_CreateSpecialChar(4, TopBottom);
  HD44780_CreateSpecialChar(5, Top);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : CS_I2C_SPI_Pin LD3_Pin LD5_Pin LD7_Pin
                           LD9_Pin LD10_Pin LD8_Pin LD6_Pin */
  GPIO_InitStruct.Pin = CS_I2C_SPI_Pin|LD3_Pin|LD5_Pin|LD7_Pin
                          |LD9_Pin|LD10_Pin|LD8_Pin|LD6_Pin;
